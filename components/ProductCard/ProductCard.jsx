...
const ProductCard = ({
  ...
  return (
    <div className="w-64 h-[24rem] bg-white p-2 space-y-1 rounded-md shadow-md">
...
// @ts-ignore
            word => <p key={word} className="border border-gray-200 rounded-md text-sm w-fit px-2">{word}</p>)}
        </div>
